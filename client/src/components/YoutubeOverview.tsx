...
function YoutubeOverview() {
  ...
  async function generateStudySession(session: any) {
    console.log(session)
    const response = await getStudySessionPlan(studySession)
